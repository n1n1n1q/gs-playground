...
def save_cameras_txt(views, estimated_focals, save_dir):
    width, height = views[0]["img"].shape[2], views[0]["img"].shape[1]
...
def save_points3D_txt(preds, views, conf_threshold, save_dir):
    ...
    #         point_id = 0
    #         for xyz, conf, rgb in zip(pts3d, confidences, colors):
    #             print(xyz.shape, conf.shape, rgb.shape)
